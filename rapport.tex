...
\section{User manual}
\begin{itemize}
\item achette un ordi
\item Mettre un fichier sur la carte SD formatee en fat32, fichier .m64
\item Etre sur de l'etat du jeux ( no save pour la majorite des TAS )
\item Verifier que le switch est bien sur lecture du fichier avant de lancer la console.
\item Connection PCB a la console via le port manette.

\item comment que ca marche
\subsection

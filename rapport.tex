...
\item TAS didn't finish the game : Check if the games is in right initial state at the launch
\end{itemize}

\subsubsection{Passthrougt mode}
\begin{itemize}
\item The character moves itself : Check if the switch is on Passthrought

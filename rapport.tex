...
then released to its initial state, as pictured in figure \ref{0bit}.
...
1 state: the voltage value of the signal is lowered to \SI{0.655}{\V} for
\SI1{\us} and then released to its initial state, as in figure \ref{1bit}.
